...
extension ObservableType {
    public func throttleForUI(_ dueTime: RxTimeInterval = .milliseconds(500)) -> Observable<Element> {
        return throttle(dueTime, latest: false, scheduler: MainScheduler.instance)
    }
}

extension SharedSequenceConvertibleType {
    public func throttleForUI(_ dueTime: RxTimeInterval = .milliseconds(500)) -> SharedSequence<SharingStrategy, Element> {
        return throttle(dueTime, latest: false)
    }
}
